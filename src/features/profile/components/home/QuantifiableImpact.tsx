...
import { HERO_STATS, SKILL_DOMAINS, ACHIEVEMENTS, PROJECTS, CATEGORY_COLORS, HEATMAP, HEATMAP_INTENSITY } from '@/data/useImpact';
import { MdMailOutline, MdBolt } from 'react-icons/md';
